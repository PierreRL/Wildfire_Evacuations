...
Table~\ref{tab:key_param_comparison} reports posterior means and 95\% credible intervals for key parameters across all fitted models. Entries marked \textemdash{} indicate that the parameter is not present in that model specification.
